...
@Component({
  selector: 'app-createrawproduct',
  templateUrl: './CreateRawProduct.component.html',
  styleUrls: ['./CreateRawProduct.component.css'],
  providers: [CreateRawProductService]
})
export class CreateRawProductComponent implements OnInit {
  ...
  constructor(private serviceCreateRawProduct: CreateRawProductService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceCreateRawProduct.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.prototype.blockchainhalal.CreateRawProduct',
    ...
    return this.serviceCreateRawProduct.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceCreateRawProduct.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceCreateRawProduct.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceCreateRawProduct.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.IngredientType) {
        formObject.IngredientType = result.IngredientType;
      } else {
        formObject.IngredientType = null;
      }
