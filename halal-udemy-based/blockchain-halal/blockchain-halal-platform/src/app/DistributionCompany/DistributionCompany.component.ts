...
@Component({
  selector: 'app-distributioncompany',
  templateUrl: './DistributionCompany.component.html',
  styleUrls: ['./DistributionCompany.component.css'],
  providers: [DistributionCompanyService]
})
export class DistributionCompanyComponent implements OnInit {
  ...
  constructor(public serviceDistributionCompany: DistributionCompanyService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceDistributionCompany.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.prototype.blockchainhalal.DistributionCompany',
    ...
    return this.serviceDistributionCompany.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceDistributionCompany.updateParticipant(form.get('CompanyId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceDistributionCompany.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceDistributionCompany.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
