...
describe('PackProductComponent', () => {
  ...
  let mockPackProductService;
  let mockDataService

  beforeEach(async(() => {

    mockPackProductService = sinon.createStubInstance(PackProductService);
    mockPackProductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: PackProductService, useValue: mockPackProductService },
