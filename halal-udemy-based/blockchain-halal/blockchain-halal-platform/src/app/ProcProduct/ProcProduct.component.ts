...
@Component({
  selector: 'app-procproduct',
  templateUrl: './ProcProduct.component.html',
  styleUrls: ['./ProcProduct.component.css'],
  providers: [ProcProductService]
})
export class ProcProductComponent implements OnInit {
  ...
  constructor(public serviceProcProduct: ProcProductService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceProcProduct.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.prototype.blockchainhalal.ProcProduct',
    ...
    return this.serviceProcProduct.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceProcProduct.updateAsset(form.get('productID').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceProcProduct.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceProcProduct.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
