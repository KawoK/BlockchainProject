...
@Component({
  selector: 'app-retailcompany',
  templateUrl: './RetailCompany.component.html',
  styleUrls: ['./RetailCompany.component.css'],
  providers: [RetailCompanyService]
})
export class RetailCompanyComponent implements OnInit {
  ...
  constructor(public serviceRetailCompany: RetailCompanyService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceRetailCompany.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.prototype.blockchainhalal.RetailCompany',
    ...
    return this.serviceRetailCompany.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceRetailCompany.updateParticipant(form.get('CompanyId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceRetailCompany.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceRetailCompany.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
