...
describe('SendPackageComponent', () => {
  ...
  let mockSendPackageService;
  let mockDataService

  beforeEach(async(() => {

    mockSendPackageService = sinon.createStubInstance(SendPackageService);
    mockSendPackageService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: SendPackageService, useValue: mockSendPackageService },
